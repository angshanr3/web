...
import Logo from './logo/ddd.png';
import CheckThinkness from './Table/Check_thinkness';
...
const Tables = () => {
    ...
    const GetData = (e) => {
       ...
       // console.log(Times);
        ...
        if(selectedOption !== "" && startDate !== "" && endDate !== "" && GetDateDiff < 7 && Times <= 0){
            axios.post('http://tw100038334:7000/test2', {
    ...
    function sortPR(a,b){
        return b.PUMPING_RATE-a.PUMPING_RATE
    }
    ...
    JsonHCL(Data,'PUMPING_RATE'); //Pumping Rate轉換成Film thickness
    ...
    function check3_judge(json,key){
        ...
        while(y < json[0].length){
          ...
          if(json[0][y].DOSE_SETTING !== ""){
            ...
            }else if(Number(json[0][y].PSH_MS) > Number(json[0][y+1].PSH_MS) && Number(json[0][y].DOSE_SETTING) <= Number(json[0][y+1].DOSE_SETTING)){
              json[0][y].linearity = "TRUE"
            }else{
        ...
        while(x < json[1].length){
          ...
          if(json[1][x].DOSE_SETTING !== ""){
            ...
            }else if(Number(json[1][x].PSH_MS) > Number(json[1][x+1].PSH_MS) && Number(json[1][x].DOSE_SETTING) <= Number(json[1][x+1].DOSE_SETTING)){
        ...
        while(t < json[2].length){
          ...
          if(json[2][t].DOSE_SETTING !== ""){
            ...
            }else if(Number(json[2][t].PSH_MS)>Number(json[2][t+1].PSH_MS) && Number(json[2][t].DOSE_SETTING) <= Number(json[2][t+1].DOSE_SETTING)){
              json[2][t].linearity = "TRUE"
            }else{
        ...
        while(k < json[3].length){
          ...
          if(json[3][k].DOSE_SETTING !== ""){
            ...
            }else if(Number(json[3][k].PSH_MS) > Number(json[3][k+1].PSH_MS) && Number(json[3][k].DOSE_SETTING) <= Number(json[3][k+1].DOSE_SETTING)){
              json[3][k].linearity = "TRUE"
            }else{
        ...
        while(z < json[4].length){
          ...
          if(json[4][z].DOSE_SETTING !== ""){
            ...
            }else if(Number(json[4][z].PSH_MS) > Number(json[4][z+1].PSH_MS) && Number(json[4][z].DOSE_SETTING) <= Number(json[4][z+1].DOSE_SETTING)){
              json[4][z].linearity = "TRUE"
            }else{
    ...
    function R_dose_thinkness_correction(json,key){
        ...
        for(var j = 0; j < json.length; j++){
            //console.log(json[j].PSH_MAIN);
            //console.log(test.Main);
            if(Number(json[j].PSH_MAIN) >= (Number(test.Main)-0.03) &&  Number(json[j].PSH_MAIN) <= (Number(test.Main)+0.03)){

                var ss = {
                    PSH_MAIN : json[j].PSH_MAIN,
                    PSH_SUB : json[j].PSH_SUB,
                    PSH_MS : json[j].PSH_MS,
                    GAP : json[j].GAP,
...
*/
    ...
    function best_same_DOSE(json,key){
        ...
        //console.log(best_same_DOSE_all);
    ...
    best_same_DOSE(check2Data,'PSH_MS');
    ...
    best_R_dose_thinkness_correction(CheckTData_ok,'PSH_MS');
            ...
            <div id="wrapper">
                ...
                <div id="main" >
                    <div class="inner">
                        ...
                        <h1 style={{ color : '#015077' }}><b>PSH 開 線 輔 助 決 策 系 統</b></h1>
                        <div className = 'data'>
                            ...
                            <div className = 'getdata'>
                                <button className="btn-get" onClick={GetData} >GetData</button>
                            ...
                            <table className="table table-bordered">
                                ...
                                <tbody >
                                    ...
                                    <tr>
                                        ...
                                        <td colSpan="2">
                                            <button className="btn-down" onClick={downloadExl}>下載</button>
                                            <InputFiles accept=".xlsx, .xls" onChange={onImportExcel}>
                                                <button className="btn-save">匯入</button>
                                            </InputFiles>
                                        </td>
                        ...
                        >
                            <Tab eventKey="check2" title="Check2">
                                <Check2 data={ check2Data } model={ test } best ={best}/>
                            </Tab>
                            <Tab eventKey="check3" title="Check3" >
                                <Check3 data={ check3Data } model={ test } best ={best} rank={check3Data_Rank}/>
                            </Tab>
                            ...
                            <Tab eventKey="checkThinkness" title="Check模厚">
                                <CheckThinkness data={ Data } model={ test } ok={CheckTData_ok} />
